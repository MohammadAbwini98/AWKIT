...
try {
  ...
  if (!NODE) {
    ...
    if (loopEditorVisible) {
      ...
      check(
        "Workflow Loop restores the enlarged above-card circle and interaction area",
      ...
      check(
        "Workflow Loop visibly travels source-to-target without replacing authored style",
      ...
      check(
        "Workflow Loop directional motion becomes a strong static cue under reduced motion",
      ...
      check(
        "The enlarged Workflow Loop arc is a reliable direct click target",
