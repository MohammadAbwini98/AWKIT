...
Historical `## HANDOFF (...)` entries moved verbatim from `docs/ai/HANDOFF.md` on 2026-09-15
so agent startup reading stays bounded (anti-loop requirement; see AGENTS.md Stopping
semantics). Entries are newest-first, then the superseded cumulative Handoff History.
