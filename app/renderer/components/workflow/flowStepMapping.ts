...
export function toNodeConfig(data: FlowDesignerNodeData): NodeConfig {
  return {
    ...
    attributeName: data.assertionType === "attribute" ? data.attributeName || undefined : undefined,
    holdMs: data.stepType === "clickAndHold" ? data.holdMs : undefined,
    storageArea: data.assertionType === "storage" ? data.storageArea : undefined,
    storageKey: data.assertionType === "storage" ? data.storageKey || undefined : undefined,
