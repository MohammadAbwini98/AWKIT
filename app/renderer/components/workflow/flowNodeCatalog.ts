...
export const flowNodeCatalog: FlowNodeCatalogItem[] = [
  ...
  { type: "press", label: "Press Shortcut", description: "Press a canonical keyboard shortcut", icon: Keyboard, requiresValue: true },
  { type: "drag", label: "Drag & Drop", description: "Drag an element onto a target", icon: Move, requiresLocator: true },
  ...
  { type: "clickAndHold", label: "Click and Hold", description: "Press, hold, then release an element", icon: MousePointer2, requiresLocator: true },
