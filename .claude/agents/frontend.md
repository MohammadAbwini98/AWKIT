---
name: frontend
description: Renderer: React, both designers, admin screens, renderer state, Hologram styles. Activates when any of `renderer_visual_change`, `interaction_change`, `accessibility_change`.
