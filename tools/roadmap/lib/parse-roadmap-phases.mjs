/**
 * Parse src/roadmap/ImplementationRoadmap.ts — the A-N phase model the app itself renders.
 *
...
export const EXPECTED_PHASE_IDS = "ABCDEFGHIJKLMN";
...
export function extractPhases(text, readError = null, mtimeMs = 0) {
  ...
  // Shape guards. The app's own page assumes A-N; a silently truncated list would understate the
