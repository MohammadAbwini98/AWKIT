/**
 * Parse src/roadmap/ImplementationRoadmap.ts — the A-M phase model the app itself renders.
 *
...
export const EXPECTED_PHASE_IDS = "ABCDEFGHIJKLM";
...
export function extractPhases(text, readError = null, mtimeMs = 0) {
  ...
  // Shape guards. The app's own page assumes A-M; a silently truncated list would understate the
